...
public class UserController {
    ...
    public List<UserDto> getAllUsers() {
        log.info("[User Service] GET /api/v1/users");
    ...
    public List<UserDto> getUsersByDepartmentId(@PathVariable Long departmentId) {
        log.info("[User Service] GET /api/v1/users/department/{}", departmentId);
    ...
    public UserDto getUserById(@PathVariable Long userId) {
        log.info("[User Service] GET /api/v1/users/{}", userId);
    ...
    public UserDto getCurrentUser() {
        log.info("[User Service] GET /api/v1/users/me");
    ...
    public UserDto assignRoleAdmin(@PathVariable Long userId) {
        log.info("[User Service] PUT /api/v1/users/{}/assign-admin", userId);
    ...
    public UserDto updateUser(@PathVariable Long userId, @RequestBody UpdateUserRequest request) {
        log.info("[User Service] PUT /api/v1/users/{}/update", userId);
    ...
    public UserDto updateCurrentUser(@RequestBody UpdateUserRequest request) {
        log.info("[User Service] PUT /api/v1/users/me");
        String username = SecurityContextHolder.getContext().getAuthentication().getName();
    ...
    public UserDto addUserToDepartment(@PathVariable Long userId, @PathVariable Long departmentId) {
        log.info("[User Service] PUT /api/v1/users/{}/department/{}", userId, departmentId);
    ...
    public ResponseEntity<?> deleteUser(@PathVariable Long userId) {
        log.info("[User Service] DELETE /api/v1/users/{}", userId);
